...
const flagData = [
  {
    name: "China",
    file: "cn.webp",
    options: ["cn.webp", "vn.webp", "tr.webp", "im.webp"],
  },
  {
    name: "United Kingdom",
    file: "gb.webp",
    options: ["fk.webp", "gb.webp", "au.webp", "gs.webp"],
  },
  {
    name: "France",
    file: "fr.webp",
    options: ["cu.webp", "ru.webp", "fr.webp", "rs.webp"],
  },
  {
    name: "Brazil",
    file: "br.webp",
    options: ["bd.webp", "pt.webp", "br.webp", "cx.webp"],
  },
  ...
  { name: "Japan", file: "jp.webp", options: ["jp.webp", "pw.webp"] },
  {
    name: "Spain",
    file: "es.webp",
    options: ["ug.webp", "es.webp", "de.webp", "me.webp"],
  },
  {
    name: "Canada",
    file: "ca.webp",
    options: ["ca.webp", "pe.webp", "lb.webp", "ge.webp"],
  },
  {
    name: "Philippines",
    file: "ph.webp",
    options: ["sx.webp", "ph.webp", "cl.webp", "cz.webp"],
  },
  {
    name: "Greece",
    file: "gr.webp",
    options: ["uy.webp", "gr.webp", "ni.webp", "fi.webp"],
  },
  ...
  { name: "Ireland", file: "ie.webp", options: ["ie.webp", "ci.webp"] },
  {
    name: "South Korea",
    file: "kr.webp",
    options: ["kp.webp", "mt.webp", "kr.webp", "jp.webp"],
  },
  {
    name: "Switzerland",
    file: "ch.webp",
    options: ["at.webp", "ch.webp", "dk.webp", "to.webp"],
  },
  {
    name: "Kenya",
    file: "ke.webp",
    options: ["sz.webp", "ly.webp", "ke.webp", "mw.webp"],
  },
  {
    name: "Hungary",
    file: "hu.webp",
    options: ["tj.webp", "mx.webp", "hu.webp", "it.webp"],
  },
  {
    name: "Egypt",
    file: "eg.webp",
    options: ["iq.webp", "sy.webp", "ye.webp", "eg.webp"],
  },
  {
    name: "Saudi Arabia",
    file: "sa.webp",
    options: ["pk.webp", "tm.webp", "sa.webp", "dz.webp"],
  },
  {
    name: "United Arab Emirates",
    file: "ae.webp",
    options: ["ae.webp", "kw.webp"],
  },
  { name: "Turkey", file: "tr.webp", options: ["tr.webp", "tn.webp"] },
  {
    name: "Morocco",
    file: "ma.webp",
    options: ["vn.webp", "ma.webp", "so.webp", "al.webp"],
  },
  {
    name: "Ghana",
    file: "gh.webp",
    options: ["sn.webp", "cm.webp", "et.webp", "gh.webp"],
  },
  {
    name: "South Africa",
    file: "za.webp",
    options: ["za.webp", "jm.webp", "tz.webp", "kn.webp"],
  },
  ...
  { name: "India", file: "in.webp", options: ["in.webp", "ne.webp"] },
  {
    name: "Venezuela",
    file: "ve.webp",
    options: ["co.webp", "ve.webp", "ad.webp", "ec.webp"],
  },
  {
    name: "Argentina",
    file: "ar.webp",
    options: ["uy.webp", "ar.webp", "sv.webp", "ni.webp"],
  },
  ...
  { name: "Thailand", file: "th.webp", options: ["th.webp", "cr.webp"] },
  {
    name: "Sweden",
    file: "se.webp",
    options: ["dk.webp", "no.webp", "se.webp", "is.webp"],
  },
  { name: "Poland", file: "pl.webp", options: ["pl.webp", "mc.webp"] },
  {
    name: "Nigeria",
    file: "ng.webp",
    options: ["nf.webp", "ng.webp", "bd.webp", "dz.webp"],
  },
  {
    name: "Ukraine",
    file: "ua.webp",
    options: ["se.webp", "ua.webp", "kz.webp", "rw.webp"],
  },
  ...
  { name: "Romania", file: "ro.webp", options: ["ro.webp", "td.webp"] },
  {
    name: "Nepal",
    file: "np.webp",
    options: ["ws.webp", "np.webp", "ao.webp", "tt.webp"],
  },
...
function showFlagGetReady() {
  ...
  <div class="quiz-container ready-card" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center;">
    <span class="ready-subtitle">${t("getReady")}</span> <!-- zobrazí GET READY podľa jazyka -->
    <h1 class="ready-title" style="margin-bottom: 20px;">${t("flagFinder")}</h1> <!-- zobrazí názov Flag Finder podľa jazyka -->
    ...
    <button id="flag-start-btn" class="magenta-btn">${t("letsGo")}</button> <!-- zobrazí LET'S GO podľa jazyka -->
  </div>
`;
...
function startFlagQuiz() {
  ...
  if (flagScreen) {
    ...
    <span id="flag-counter">
  1/${flagData.length} <!-- counter ako 1/40 -->
</span>

        <span id="flag-score-text">
          ${t("score")}: 0
        </span>
      </div>
      ...
      <button id="flag-next-btn" disabled>
        ${t("next")}
      </button>
    </div>
  `;
...
function renderFlagQuestion() {
  ...
  if (!grid || !label || !progress || !counter || !scoreDisplay || !nextBtn)
    return;
  ...
  setTimeout(() => {
    ...
    const counterEl = document.getElementById("flag-counter"); /* ja nájdem counter */
if (counterEl) {
  counterEl.textContent = `${currentFlagIndex + 1}/${flagData.length}`; /* ja ukážem napr. 5/40 */
}
    ...
    label.innerText = tCountry(question.name); /* ja nastavím preložený názov krajiny */

    // Nastavenie novej otázky
function setStatus(isCorrect) {
  const status = document.getElementById("answer-status"); /* status text */
  if (!status) return; /* stop ak chýba */

  status.className = ""; /* reset class */
  status.classList.add(isCorrect ? "correct" : "wrong"); /* farba podľa výsledku */

  status.textContent = (isCorrect ? t("correct") : t("wrong")).toUpperCase(); /* preklad + veľké písmená */
}
...
function checkFlagAnswer(selectedFile, card) {
  ...
  const setStatus = (ok) => {
    if (!status) return;
status.textContent = (ok ? t("correct") : t("wrong")).toUpperCase();    status.className = "show " + (ok ? "correct" : "wrong");
  };
...
function showFlagResults() {
  ...
  // 3. Preložený výsledkový text (rovnako ako Classic)
  const msgEl = document.getElementById("result-message"); /* text správy */
  if (msgEl) {
    const total = flagData.length || 1; /* poistka */
    const ratio = flagScore / total; /* percentá */

    const key =
      ratio >= 0.85 ? "resultGreat" :
      ratio >= 0.65 ? "resultGood" :
      ratio >= 0.35 ? "resultOk" : "resultBad";

    msgEl.textContent = t(key); /* preklad správy */
  }

  // 4. Restart button, preklad namiesto PLAY AGAIN
  ...
  if (restartBtn) {
    ...
    restartBtn.textContent = t("restart"); /* preklad tlačidla */
